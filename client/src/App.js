...
import { Bars3CenterLeftIcon, Bars4Icon, TicketIcon, HomeIcon, XMarkIcon, UserGroupIcon, WrenchIcon } from '@heroicons/react/24/outline'
import {
    ChevronRightIcon,
    ChevronUpDownIcon,
...
const navigation = [
    ...
    { name: 'Tasks', href: '#', icon: TicketIcon, current: false},
    { name: 'Opportunities', href: '#', icon: Bars4Icon, current: false},
    { name: 'Contacts', href: '/contacts', icon: UserGroupIcon, current: false},
    { name: 'Integrations', href: '/integrations', icon: WrenchIcon, current: false }
]
const teams = [
    { name: 'NAMER Sales', href: '#', bgColorClass: 'bg-indigo-500' },
    { name: 'EMEA Sales', href: '#', bgColorClass: 'bg-green-500' },
                                    ...
                                    <span className="flex w-full items-center justify-between">
                                        <span className="flex min-w-0 items-center justify-between space-x-3">
                                            <img
                                                ...
                                                src="https://i.imgur.com/snmE2di.jpg?1"
                                                alt=""
                                            />
                                            <span className="flex min-w-0 flex-1 flex-col">
                                                <span className="truncate text-sm font-medium text-gray-900">Andrew Murphy</span>
                                                <span className="truncate text-sm text-gray-500">@amurphy</span>
                                            </span>
                                        </span>
                                        <ChevronUpDownIcon
