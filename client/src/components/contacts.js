        ...
        <main className="flex-1">
            ...
            <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
                <div className="min-w-0 flex-1">
                    <h1 className="text-lg font-medium leading-6 text-gray-900 sm:truncate">Contacts</h1>
                </div>
            </div>
            {/* Pinned projects */}
            <div className="mt-6 px-4 sm:px-6 lg:px-8">
                <h2 className="text-sm font-medium text-gray-900">Pinned POCs</h2>
                        ...
                        <li key={project.id} className="relative col-span-1 flex rounded-md shadow-sm">
                            ...
                            <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white">
                                <div className="flex-1 truncate px-4 py-2 text-sm">
                                    ...
                                    <p className="text-gray-500">{project.ACV}</p>
                                </div>
                        ...
                        <thead>
                            <tr className="border-t border-gray-200">
                                <th
                                    ...
                                    scope="col"
                                >
                                    <span className="lg:pl-2">Contact</span>
                                </th>
                                <th
                                    className="border-b border-gray-200 bg-gray-50 px-6 py-3 text-left text-sm font-semibold text-gray-900"
                                    scope="col"
